            ...
            <div className="flex items-center justify-between px-5 py-3 border-b border-white/10 flex-shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Infos visibles par tous</p>
                </div>
              </div>
              <button
                onClick={onClose}
              ...
              <div className="px-5 pb-2 flex flex-col gap-3">
                ...
                <div>
                  <label className="flex items-center gap-1.5 text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">
                    <User className="w-3 h-3" /> Nom affiché
                  </label>
                  <Input
                    value={displayName}
                ...
                <div>
                  <label className="flex items-center gap-1.5 text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">
                    <AtSign className="w-3 h-3" /> Identifiant
                  </label>
                  <div className="relative">
                  ...
                  <p className="text-[10px] text-muted-foreground mt-1">3–20 caractères, lettres, chiffres et _ uniquement</p>
                </div>
