...
export default function Register() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 min-h-full w-full flex flex-col items-center justify-center px-4 py-3">
        <div className="w-full max-w-sm flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            <h1 className="text-xl font-bold tracking-tight text-gradient-primary">{t.title}</h1>
